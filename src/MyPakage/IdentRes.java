...
public class IdentRes implements Comparable<IdentRes> {
    ...
    public int num;     // начало элемента, для диагноали 0- слева направо, n-1 справо на лево
    public int stepOfend;  // количество шагов до окончания
    public int preferredCell; // предпочитаемая ячейка, для определения оптимального хода
